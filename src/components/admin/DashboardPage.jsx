...
const DashboardPage = () => {
    ...
    return (<>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Link href="/admin/products" className="bg-card rounded-xl p-6 shadow-soft hover:shadow-medium transition-shadow flex items-center gap-4 group">
        ...
        <Link href="/admin/orders" className="bg-card rounded-xl p-6 shadow-soft hover:shadow-medium transition-shadow flex items-center gap-4 group">
        ...
        <Link href="/admin/categories" className="bg-card rounded-xl p-6 shadow-soft hover:shadow-medium transition-shadow flex items-center gap-4 group">
